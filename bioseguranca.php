    ...
    <div class="container text-center">
        ...
        <div class="row align-items-start teste">
            ...
            <div class="col lado-esquerdo">
                ...
                <p class="texto-bloco">A lavagem diária está totalmente ligada à durabilidade dos cílios.<br> Ao contrário
                    ...
                    Em seguida, enxágue com água fria, tirando todo o resíduo de shampoo;<br>
                    Finalize secando os fios com um papel e escove para deixá-los alinhados.
                </p>
            </div>
        </div>
        ...
        <div class="row align-items-start teste">
         ...
         <div class="row align-items-start teste">
            ...
            <div class="col lado-esquerdo">
                <h1 class="titulo-bloco">MATERIAIS</h1>
